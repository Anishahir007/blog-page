...
const Author = () => {
  ...
  useEffect(()=>{
    const getAuthors = async () =>{
      ...
      try {
        const response = await axios.get(`https://blog-page-backend.onrender.com/api/users`);
      ...
      authors.length > 0 ? <div className='container authors_container'>
        {
          ...
          <div className="author_avatar">
            <img src={`https://blog-page-backend.onrender.com/uploads/${avatar}`} alt={`Image of ${name}`} />
